...

{
  "results": [
    { 
      ...
      "explanation": "Pro: [Advantage]. Con: [Disadvantage]. [Brief summary]. [If multiple users suggested this idea, mention it at the end: 'This idea was proposed by multiple users.']" 
    }
  ],
